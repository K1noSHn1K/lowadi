...
function settings()
	{
		...
		$('body#global').append('<div class="lwb_settings" style="display: none; position: fixed; width: 550px; height:700px; top: 105px; left: 130px; z-index: 999; padding:5px; background-color:rgba(0, 0, 0, 0.85);  border-radius: 0px 5px 5px 5px;"></div>');
