...
function settings()
	{
		...
		$('.lwb').append('<br><br> <span style="font-family: Arial,Helvetica,sans-serif; font-size: 11px; color:#F1F9F1;">Предлагать случки</span> <input id="slchkbx" name="slchkbx" value="1" type="checkbox">');
