...
if (/\/elevage\/chevaux\/cheval\?id=/.test(window.location.href))
{
  ...
  if ($("#boutonCoucher").find("span:contains('Отправить спать')").html()=='Отправить спать')
  {
  	alert(horse_id);
...
function settings()
	{
		...
		$('.lwb').append('<center><span class="header-currency-label" style="color:#fafe6c;"><b>LowadiBot v1.3.4</b>   </span>  </center>');
		...
		$('body#global').append('<div class="lwb_settings" style="display: none; position: fixed; width: 400px; height:170px; top: 100px; left: 125px; z-index: 999; padding:5px; background-color:rgba(92, 92, 92, 0.9);  border-radius: 0px 0px 0px 0px;"></div>');
