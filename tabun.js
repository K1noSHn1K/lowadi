...
function settings()
	{
		$('body#global').append('<div class="lwb_logo" style="display: block; position: fixed; width: 105px; top: 30px; left: 5px; z-index: 900;"><img src="https://raw.githubusercontent.com/Crasher69/lowadi/master/kraken.png" width="110px"></div>');
